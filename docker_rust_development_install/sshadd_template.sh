...
# ~/.ssh/sshadd.sh
# Inside this template, replace the words github_com_git_ssh_1 and your_webserver_your_username_ssh_1 
...
cat ~/.ssh/config | grep -q "~/.ssh/your_webserver_your_username_ssh_1" || echo "The ~/.ssh/config does not contain the identity ~/.ssh/your_webserver_your_username_ssh_1."
