...
if echo "$PWD" | grep -q '/rustprojects/docker_rust_development_install'; then
    ...
    then
        ...
        echo "\033[0;33m    I will call these keys github_com_ssh_1 and bestia_dev_ssh_1, but you can have other names. \033[0m"
        ...
        echo "\033[0;32m cp github_com_ssh_1 ~/.ssh; \033[0m"
        echo "\033[0;32m chmod 600 ~/.ssh/github_com_ssh_1; \033[0m"
        echo "\033[0;32m cp github_com_ssh_1.pub ~/.ssh; \033[0m"
        echo "\033[0;32m cp bestia_dev_ssh_1 ~/.ssh; \033[0m"
        echo "\033[0;32m chmod 600 ~/.ssh/bestia_dev_ssh_1; \033[0m"
        echo "\033[0;32m cp bestia_dev_ssh_1.pub ~/.ssh; \033[0m"
        ...
        echo "\033[0;32m sh store_personal_keys_and_settings.sh info@your.mail your_name github_com_ssh_1 bestia_dev_ssh_1; \033[0m"
    fi
else
    echo " "
