...
echo "\033[0;33m    Version of vscode: 1.70.2 \033[0m"
echo "\033[0;33m    Commit hash of VSCode: e4503b30fc78200f846c62cf8091b76ff5547662 \033[0m"
...
buildah from --name rust_dev_vscode_img docker.io/bestiadev/rust_dev_cargo_img:cargo-1.63.0

buildah config \
--author=github.com/bestia-dev \
--label name=rust_dev_vscode_img \
--label version=vscode-1.70.2 \
...
echo "\033[0;33m    version 1.70.2 \033[0m"
echo "\033[0;33m    e4503b30fc78200f846c62cf8091b76ff5547662 \033[0m"
buildah run rust_dev_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662'
buildah run rust_dev_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/extensions'
buildah run rust_dev_vscode_img /bin/sh -c 'curl -L -s https://update.code.visualstudio.com/commit:e4503b30fc78200f846c62cf8091b76ff5547662/server-linux-x64/stable --output /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c 'tar --no-same-owner -xzv --strip-components=1 -C ~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662 -f /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c 'rm /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension streetsidesoftware.code-spell-checker'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension rust-lang.rust-analyzer'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension davidanson.vscode-markdownlint'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension 2gua.rainbow-brackets'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension dotjoshjohnson.xml'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension serayuzgur.crates'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/e4503b30fc78200f846c62cf8091b76ff5547662/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension ms-vscode.live-server'
...
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:vscode-1.70.2
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:cargo-1.63.0
...
echo "\033[0;33m podman push docker.io/bestiadev/rust_dev_vscode_img:vscode-1.70.2 \033[0m"
