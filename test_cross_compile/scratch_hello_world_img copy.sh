...
printf " \n"
printf "\033[0;33m    Bash script to build scratch image to test execute hello_world with and without musl. \033[0m\n"
printf "\033[0;33m    Name of the image: scratch_hello_world_img \033[0m\n"
...
printf "\033[0;33m    That can be run from a minimal scratch Linux OCI container. Only 5MB.  \033[0m\n"
printf "\033[0;33m    By default Rust programs are dynamically linked to glibc and that cannot work on scratch,  \033[0m\n"
...
printf "\033[0;33m sh scratch_hello_world_img.sh \033[0m\n"
...
set -e
buildah rm scratch_hello_world_img || :
buildah rmi -f docker.io/bestiadev/scratch_hello_world_img || :

printf " \n"
printf "\033[0;33m    Create new 'buildah container' named scratch_hello_world_img \033[0m\n"
set -o errexit
buildah from \
...
printf " \n"
printf "\033[0;33m    Finally save/commit the image named scratch_hello_world_img \033[0m\n"
...
printf "\033[0;32m podman run scratch_hello_world_img /usr/bin/crustde_hello_musl \033[0m\n"
printf "\033[0;33m    The second executable will fail because the glibc is missing in scratch. \033[0m\n"
printf "\033[0;32m podman run scratch_hello_world_img /usr/bin/crustde_hello_glibc \033[0m\n"
printf " \n"