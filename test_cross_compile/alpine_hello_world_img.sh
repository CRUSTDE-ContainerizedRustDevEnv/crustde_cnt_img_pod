...
echo "\033[0;32m podman run alpine_hello_world_img /usr/bin/crustde_hello_musl \033[0m"
echo "\033[0;33m    The second executable will fail because the glibc is missing in Alpine. \033[0m"
echo "\033[0;32m podman run alpine_hello_world_img /usr/bin/crustde_hello_glibc \033[0m"
echo " "