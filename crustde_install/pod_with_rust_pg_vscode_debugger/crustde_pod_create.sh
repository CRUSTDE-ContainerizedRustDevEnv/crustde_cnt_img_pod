...
echo "\033[0;33m    This 'pod' is made of 3 containers: 'crustde_squid_cnt', 'crustde_vscode_cnt', 'crustde_postgres_cnt' \033[0m"
...
cd ~/rustprojects/crustde_install/pod_with_rust_pg_vscode_debugger/
