...
printf " \n"
printf "\033[0;33m    You can connect VSCode to an existing project inside the container from the host bash or git-bash: \033[0m\n"
printf "\033[0;33m    Use sshadd to store the private key for SSH connections. \033[0m\n"
printf "\033[0;32m sshadd \033[0m\n"
printf "\033[0;32m MSYS_NO_PATHCONV=1 code --remote ssh-remote+crustde_rustdevuser_ssh_1 /home/rustdevuser/rustprojects \033[0m\n"
