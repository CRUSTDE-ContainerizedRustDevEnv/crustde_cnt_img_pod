...
printf "\033[0;33m    This special pod is made for the project 'dropbox_backup_to_external_disk' \033[0m\n"
printf "\033[0;33m    This adds a mounted volume to /mnt/e/DropBoxBackup2/ and a squid allowed access to dropbox.com. \033[0m\n"
printf "\033[0;33m    For testing purposes I will use a folder on my internal disk named d:\mnt_e_DropboxBackup2/ \033[0m\n"
...
# The directory on the external disk is read-write to all. I don't need special permissions.
# Permissions can be complex in rootless podman. You need to use 'podman unshare'.
printf " \n"
printf "\033[0;33m    The external disk with Dropbox backup directory must exist. \033[0m\n"
printf "\033[0;33m    ls -al /mnt/d/mnt_e_DropboxBackup2 \033[0m\n"
printf "\033[0;33m    --volume /mnt/e/DropBoxBackup2:/mnt/e/DropBoxBackup2:Z \ \033[0m\n"
...
if grep -qi microsoft /proc/version; then
    printf "\033[0;33m    You can force the WSL reboot in git-bash:  \033[0m\n"
