...
printf "\033[0;33m    MSYS_NO_PATHCONV=1 scp ~/rustprojects/crustde_rustprojects_backup/crustde_rustprojects_backup.tar.gz rustdevuser@crustde_rustdevuser:~/crustde_rustprojects_backup.tar.gz \033[0m\n"
MSYS_NO_PATHCONV=1 scp ~/rustprojects/crustde_rustprojects_backup/crustde_rustprojects_backup.tar.gz rustdevuser@crustde_rustdevuser:~/crustde_rustprojects_backup.tar.gz
