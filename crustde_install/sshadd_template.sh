...
cat ~/.ssh/config | grep -q "~/.ssh/github_com_git_ssh_1" || printf "The ~/.ssh/config does not contain the identity ~/.ssh/github_com_git_ssh_1.\n"
cat ~/.ssh/config | grep -q "~/.ssh/your_key_for_webserver_ssh_1" || printf "The ~/.ssh/config does not contain the identity ~/.ssh/your_key_for_webserver_ssh_1.\n"
