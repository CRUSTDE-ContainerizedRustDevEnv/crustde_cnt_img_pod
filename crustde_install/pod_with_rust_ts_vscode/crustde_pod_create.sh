...
printf "\033[0;33m    This 'pod' is made of 2 containers: 'crustde_squid_cnt' and 'rust_ts_dev_vscode_cnt' \033[0m\n"
printf "\033[0;33m    It contains Rust, cargo, rustc, VSCode and typescript development environment' \033[0m\n"
