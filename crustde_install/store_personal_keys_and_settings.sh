...
# info@your.mail your_gitname github_com_git_ssh_1 your_webserver your_username your_key_for_webserver_ssh_1
...
sed -i.bak "s/github_com_git_ssh_1/$3/g" ~/.ssh/crustde_pod_keys/personal_keys_and_settings.sh
...
sed -i.bak "s/github_com_git_ssh_1/$3/g" ~/.ssh/crustde_pod_keys/sshadd.sh
...
sed -i.bak "s/github_com_git_ssh_1/$3/g" ~/.ssh/crustde_pod_keys/config
