...
echo "\033[0;33m    Version of vscode: 1.78.2 \033[0m"
echo "\033[0;33m    Commit hash of VSCode: b3e4e68a0bc097f0ae7907b217c1119af9e03435 \033[0m"
...
echo "\033[0;33m    version vscode 1.78.2 \033[0m"
...
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/b3e4e68a0bc097f0ae7907b217c1119af9e03435/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension mtxr.sqltools'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/b3e4e68a0bc097f0ae7907b217c1119af9e03435/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension mtxr.sqltools-driver-pg'
...
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:vscode-1.78.2
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:cargo-1.69.0
...
echo "\033[0;32m podman push docker.io/bestiadev/rust_dev_vscode_img:vscode-1.78.2 \033[0m"
echo "\033[0;32m podman push docker.io/bestiadev/rust_dev_vscode_img:cargo-1.69.0 \033[0m"
