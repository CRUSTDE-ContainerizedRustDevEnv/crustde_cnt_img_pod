...
docker.io/bestiadev/rust_dev_cross_img:cargo-1.77.0
...
buildah run rust_dev_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6'
buildah run rust_dev_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/extensions'
buildah run rust_dev_vscode_img /bin/sh -c 'curl -L https://update.code.visualstudio.com/commit:863d2581ecda6849923a2118d93a088b0745d9d6/server-linux-x64/stable --output /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c 'tar --no-same-owner -xzv --strip-components=1 -C ~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6 -f /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c 'rm /tmp/vscode-server-linux-x64.tar.gz'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension streetsidesoftware.code-spell-checker'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension rust-lang.rust-analyzer'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension davidanson.vscode-markdownlint'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension dotjoshjohnson.xml'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension serayuzgur.crates'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension ms-vscode.live-server'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension mtxr.sqltools'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension mtxr.sqltools-driver-pg'
buildah run rust_dev_vscode_img /bin/sh -c '~/.vscode-server/bin/863d2581ecda6849923a2118d93a088b0745d9d6/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension znck.grammarly'
...
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:vscode-1.87.2
buildah tag docker.io/bestiadev/rust_dev_vscode_img:latest docker.io/bestiadev/rust_dev_vscode_img:cargo-1.77.0
...
echo "\033[0;32m podman push docker.io/bestiadev/rust_dev_vscode_img:vscode-1.87.2 \033[0m"
echo "\033[0;32m podman push docker.io/bestiadev/rust_dev_vscode_img:cargo-1.77.0 \033[0m"
