...
buildah tag docker.io/bestiadev/crustde_cross_img:latest docker.io/bestiadev/crustde_cross_img:cargo-1.88.0

printf " \n"
printf "\033[0;33m    Upload the new image to docker hub. \033[0m\n"
printf "\033[0;32m ./ssh_auth_podman_push docker.io/bestiadev/crustde_cross_img:cargo-1.88.0 \033[0m\n"
