...
echo "\033[0;33m sh crustde_cross_img.sh \033[0m"
...
echo " "
echo "\033[0;33m    Create new 'buildah container' named crustde_cross_img \033[0m"
set -o errexit
buildah from \
...
echo " "
echo "\033[0;33m    Finally save/commit the image named crustde_cross_img \033[0m"
buildah commit crustde_cross_img docker.io/bestiadev/crustde_cross_img:latest
buildah tag docker.io/bestiadev/crustde_cross_img:latest docker.io/bestiadev/crustde_cross_img:cargo-1.77.0
...
echo "\033[0;32m podman push docker.io/bestiadev/crustde_cross_img:cargo-1.77.0 \033[0m"
echo "\033[0;32m podman push docker.io/bestiadev/crustde_cross_img:latest \033[0m"

echo " "
echo "\033[0;33m    To create the container 'crustde_cross_cnt' use: \033[0m"
echo "\033[0;32m podman create -ti --name crustde_cross_cnt docker.io/bestiadev/crustde_cross_img:latest \033[0m"
echo "\033[0;32m podman restart crustde_cross_cnt \033[0m"
echo "\033[0;32m podman exec -it crustde_cross_cnt bash \033[0m"
...
echo "\033[0;32m sh crustde_vscode_img.sh \033[0m"
echo " "