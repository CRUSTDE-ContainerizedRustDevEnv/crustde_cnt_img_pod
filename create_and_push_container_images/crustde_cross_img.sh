...
printf " \n"
printf "\033[0;33m    Install zip because windows doesn't work with tar.gz \033[0m\n"
buildah run --user root crustde_cross_img /bin/sh -c 'apt-get install -y zip'
...
buildah tag docker.io/bestiadev/crustde_cross_img:latest docker.io/bestiadev/crustde_cross_img:cargo-1.89.0

printf " \n"
printf "\033[0;33m    Upload the new image to docker hub. \033[0m\n"
printf "\033[0;32m ./ssh_auth_podman_push docker.io/bestiadev/crustde_cross_img:cargo-1.89.0 \033[0m\n"
