...
printf "\033[0;33m    Version of vscode: 1.96.4 \033[0m\n"
printf "\033[0;33m    Commit hash of VSCode: cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba \033[0m\n"
...
docker.io/bestiadev/crustde_cross_img:cargo-1.84.0

buildah config \
--author=github.com/bestia-dev \
--label name=crustde_vscode_img \
--label version=vscode-1.96.4 \
...
printf "\033[0;33m    version vscode 1.96.4 \033[0m\n"
printf "\033[0;33m    cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba \033[0m\n"
buildah run crustde_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/bin/cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba'
buildah run crustde_vscode_img /bin/sh -c 'mkdir -vp ~/.vscode-server/extensions'
buildah run crustde_vscode_img /bin/sh -c 'curl -L https://update.code.visualstudio.com/commit:cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba/server-linux-x64/stable --output /tmp/vscode-server-linux-x64.tar.gz'
buildah run crustde_vscode_img /bin/sh -c 'tar --no-same-owner -xzv --strip-components=1 -C ~/.vscode-server/bin/cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba -f /tmp/vscode-server-linux-x64.tar.gz'
buildah run crustde_vscode_img /bin/sh -c 'rm /tmp/vscode-server-linux-x64.tar.gz'
buildah run crustde_vscode_img /bin/sh -c '~/.vscode-server/bin/cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension streetsidesoftware.code-spell-checker'
buildah run crustde_vscode_img /bin/sh -c '~/.vscode-server/bin/cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension rust-lang.rust-analyzer'
buildah run crustde_vscode_img /bin/sh -c '~/.vscode-server/bin/cd4ee3b1c348a13bafd8f9ad8060705f6d4b9cba/bin/code-server --extensions-dir ~/.vscode-server/extensions --install-extension davidanson.vscode-markdownlint'
...
buildah tag docker.io/bestiadev/crustde_vscode_img:latest docker.io/bestiadev/crustde_vscode_img:vscode-1.96.4
buildah tag docker.io/bestiadev/crustde_vscode_img:latest docker.io/bestiadev/crustde_vscode_img:cargo-1.84.0

printf " \n"
printf "\033[0;33m    Upload the new image to docker hub. \033[0m\n"
printf "\033[0;32m ./ssh_auth_podman_push docker.io/bestiadev/crustde_vscode_img:vscode-1.96.4 \033[0m\n"
printf "\033[0;32m ./ssh_auth_podman_push docker.io/bestiadev/crustde_vscode_img:cargo-1.84.0 \033[0m\n"
