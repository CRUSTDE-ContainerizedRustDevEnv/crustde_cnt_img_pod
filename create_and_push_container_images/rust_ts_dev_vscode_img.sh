...
buildah from --name rust_ts_dev_vscode_img docker.io/bestiadev/rust_dev_vscode_img:vscode-1.77.3
...
buildah tag docker.io/bestiadev/rust_ts_dev_vscode_img:latest docker.io/bestiadev/rust_ts_dev_vscode_img:vscode-1.77.3
...
echo "\033[0;32m podman push docker.io/bestiadev/rust_ts_dev_vscode_img:vscode-1.77.3 \033[0m"
