...
buildah from --name rust_ts_dev_vscode_img docker.io/bestiadev/crustde_vscode_img:vscode-1.104.2
...
buildah tag docker.io/bestiadev/rust_ts_dev_vscode_img:latest docker.io/bestiadev/rust_ts_dev_vscode_img:vscode-1.104.2
buildah tag docker.io/bestiadev/rust_ts_dev_vscode_img:latest docker.io/bestiadev/rust_ts_dev_vscode_img:cargo-1.90.0
