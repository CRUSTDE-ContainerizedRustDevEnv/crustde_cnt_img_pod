...
buildah from --name rust_ts_dev_vscode_img docker.io/bestiadev/crustde_vscode_img:vscode-1.88.0
...
buildah tag docker.io/bestiadev/rust_ts_dev_vscode_img:latest docker.io/bestiadev/rust_ts_dev_vscode_img:vscode-1.88.0
buildah tag docker.io/bestiadev/rust_ts_dev_vscode_img:latest docker.io/bestiadev/rust_ts_dev_vscode_img:cargo-1.77.1
...
printf "\033[0;32m podman push docker.io/bestiadev/rust_ts_dev_vscode_img:typescript-4.7.4 \033[0m\n"
printf "\033[0;32m podman push docker.io/bestiadev/rust_ts_dev_vscode_img:vscode-1.88.0 \033[0m\n"
