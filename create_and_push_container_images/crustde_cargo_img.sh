...
printf " \n"
printf "\033[0;33m    Install 'mold linker' 2.40.3. It is 3x faster. \033[0m\n"
buildah run crustde_cargo_img /bin/sh -c 'curl -L https://github.com/rui314/mold/releases/download/v2.40.3/mold-2.40.3-x86_64-linux.tar.gz --output /tmp/mold.tar.gz'
...
buildah tag docker.io/bestiadev/crustde_cargo_img:latest docker.io/bestiadev/crustde_cargo_img:cargo-1.89.0

printf " \n"
printf "\033[0;33m    Upload the new image to docker hub. \033[0m\n"
printf "\033[0;32m chmod +x ./ssh_auth_podman_push \033[0m\n"
printf "\033[0;32m ./ssh_auth_podman_push docker.io/bestiadev/crustde_cargo_img:cargo-1.89.0 \033[0m\n"
