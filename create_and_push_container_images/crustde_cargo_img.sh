...
echo "\033[0;33m    Open source code MIT: https://github.com/CRUSTDE-Containerized-Rust-Dev-Env/crustde_cnt_img_pod \033[0m"
...
echo "\033[0;33m    Version of rustup: 1.27.0 \033[0m"
...
echo "\033[0;33m sh crustde_cargo_img.sh \033[0m"
...
echo " "
echo "\033[0;33m    Create new 'buildah container' named crustde_cargo_img \033[0m"
set -o errexit
buildah from \
...
buildah run crustde_cargo_img /bin/sh -c 'echo "set bell-style none" >> ~/.inputrc'

echo " "
echo "\033[0;33m    Install rustup 1.27.0 and default x86_64-unknown-linux-gnu, cargo, std, rustfmt, clippy, docs, rustc,...  \033[0m"
...
echo " "
echo "\033[0;33m    Install 'mold linker' 2.30.0. It is 3x faster. \033[0m"
buildah run crustde_cargo_img /bin/sh -c 'curl -L https://github.com/rui314/mold/releases/download/v2.30.0/mold-2.30.0-x86_64-linux.tar.gz --output /tmp/mold.tar.gz'
...
buildah run crustde_cargo_img /bin/sh -c 'echo "alias l=\"ls -al\"" >> ~/.bashrc'
buildah run crustde_cargo_img /bin/sh -c 'echo "alias ll=\"ls -l\"" >> ~/.bashrc'
...
echo " "
echo "\033[0;33m    Finally save/commit the image named crustde_cargo_img \033[0m"
buildah commit crustde_cargo_img docker.io/bestiadev/crustde_cargo_img:latest
buildah tag docker.io/bestiadev/crustde_cargo_img:latest docker.io/bestiadev/crustde_cargo_img:cargo-1.77.0
...
echo "\033[0;32m podman push docker.io/bestiadev/crustde_cargo_img:cargo-1.77.0 \033[0m"
echo "\033[0;32m podman push docker.io/bestiadev/crustde_cargo_img:latest \033[0m"

echo " "
echo "\033[0;33m    To create the container 'crustde_cargo_cnt' use: \033[0m"
echo "\033[0;32m podman create -ti --name crustde_cargo_cnt docker.io/bestiadev/crustde_cargo_img:latest \033[0m"
echo "\033[0;32m podman restart crustde_cargo_cnt \033[0m"
echo "\033[0;32m podman exec -it crustde_cargo_cnt bash \033[0m"

echo " "
echo "\033[0;33m    Try to build and run a sample Rust project: \033[0m"
echo "\033[0;32m cd ~/rustprojects \033[0m"
echo "\033[0;32m cargo new crustde_hello \033[0m"
echo "\033[0;32m cd crustde_hello \033[0m"
...
echo "\033[0;32m sh crustde_cross_img.sh \033[0m"
echo " "