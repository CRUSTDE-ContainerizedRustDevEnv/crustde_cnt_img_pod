...
printf " \n"
printf "\033[0;33m    Install 'mold linker' 2.30.0. It is 3x faster. \033[0m\n"
...
printf "\033[0;32m podman push docker.io/bestiadev/crustde_cargo_img:cargo-1.77.0 \033[0m\n"
