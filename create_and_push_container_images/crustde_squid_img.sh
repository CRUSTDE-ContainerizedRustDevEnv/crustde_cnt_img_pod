...
printf "\033[0;32m ./podman_ssh_auth push docker.io/bestiadev/crustde_squid_img:squid-3.5.27-2 \033[0m\n"
printf "\033[0;32m ./podman_ssh_auth push docker.io/bestiadev/crustde_squid_img:latest \033[0m\n"
...
printf "\033[0;32m curl http://httpbin.org/ip \033[0m\n"
printf "The answer shohuld be:\n"
printf "origin: 127.0.0.1, 46.123.241.93\n"
printf "\033[0;32m curl http://google.com \033[0m\n"
...
printf "<div id='footer'><p>Generated by crustde_pod (squid/3.5.27)</p>\n"
