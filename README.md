...
podman push docker.io/bestiadev/rust_dev_cargo_img:cargo-1.72.1
podman push docker.io/bestiadev/rust_dev_cargo_img:latest

podman push docker.io/bestiadev/rust_dev_cross_img:cargo-1.72.1
podman push docker.io/bestiadev/rust_dev_cross_img:latest

podman push docker.io/bestiadev/rust_dev_vscode_img:vscode-1.82.3
podman push docker.io/bestiadev/rust_dev_vscode_img:cargo-1.72.1
...
| ---------------------------------------- | -------------- |------------- | ----------- |
| docker.io/bestiadev/rust_dev_cargo_img   | cargo-1.72.1   | 1.30 GB      | 0.59 GB     |
| docker.io/bestiadev/rust_dev_cross_img   | cargo-1.72.1   | 1.70 GB      | 0.57 GB     |
| docker.io/bestiadev/rust_dev_vscode_img  | cargo-1.72.1   | 0.27 GB      | 0.10 GB     |
